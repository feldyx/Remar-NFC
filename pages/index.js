		...
		<>
			...
			<div className='flex flex-col items-center h-screen text-center'>
				...
				<div className='flex flex-col items-end h-screen w-screen'>
					<IonFabButton className='text-[40px] sticky top-[85%] right-[10%] ' color="dark-purple" 
					onClick={
						()=>{console.log("setlist: ", listItems)
							setListItems(!listItems)}}
						>  <span class="mb-2">+</span>
					</IonFabButton>
					{listItems && <div className='flex flex-col bg-[#faf9f6]' id="popup">
